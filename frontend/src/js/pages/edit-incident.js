...
export async function renderEditIncident() {
  ...
  content.innerHTML = `
    ...
    <div class="card">
      <div class="card__body" style="padding:0">
        ${buildTabsHTML('padding:0 24px', { showVehicles: true, showPersonnel: true, showAttachments: true })}
      </div>
    </div>
  ...
  // Phase B: Fahrzeuge & Personal laden (unabhängig von Fahrzeuge/Personal-Modul)
  loadVehiclesTab(_incidentId, false);
  loadPersonnelTab(_incidentId, false);
